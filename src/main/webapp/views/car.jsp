...
<script>
    ...
    layui.use(['paging', 'form'], function () {
        ...
        paging.init({
            openWait: true,
            url: '${pageContext.request.contextPath}/car/getCurrentCarPage.do', //地址
        ...
        $('#search').on('click', function () {
            layui.use(['paging', 'form'], function () {
                ...
                var start_day = $(" input[ name='enter_time' ] ").val();
                var end_day = $(" input[ name='leave_time' ] ").val();
                paging.init({
                    openWait: true,
                    url: '${pageContext.request.contextPath}/car/findSpotCarByNameOrTime.do', //地址
                    elem: '#content', //内容容器
                    params: { //发送到服务端的参数
        ...
        layer.alert('是否删除？？', {
            ...
            , yes: function () {
                layui.use('layer', function () {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "${pageContext.request.contextPath}/car/deleteByCodeAndTime.do",
                        data: {code: code, day: time},
                        dataType: "text",
