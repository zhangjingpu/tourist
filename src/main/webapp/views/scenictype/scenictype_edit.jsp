...
<div style="margin: 15px;">
    ...
    <form class="layui-form" id="form1" action="${pageContext.request.contextPath}/scenictype/editScenictypeMenu.do">
        <input type="hidden" name="id" value="${id}"> 　
        <div class="layui-form-item">
            <label class="layui-form-label">景区类型名称</label>
            <div class="layui-input-inline">
                <input type="text" name="name" value="${scenictypename}" lay-verify="title" autocomplete="off"
