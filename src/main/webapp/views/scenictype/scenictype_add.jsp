...
<div style="margin: 15px;">
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>添加景区类型信息</legend>
    </fieldset>

    <form class="layui-form" id="form1" action="${pageContext.request.contextPath}/scenictype/insertScenictype.do">
        <input type="hidden" name="status" value="0" id="status1"> 　
        <div class="layui-form-item">
            <label class="layui-form-label">景区类型名称</label>
            <div class="layui-input-inline">
                <input type="text" name="name" value="${scenictype.scenictype_name}" lay-verify="title"
                       autocomplete="off"
                       placeholder="请输入景区名称"
                       class="layui-input">
            </div>
