...
public class ReadExcelParkingCar {
     ...
     * @return
     */
    public List<ParkingCar> getExcelCarInfo(MultipartFile Mfile) {
        ...
        //初始化客户信息的集合
        List<ParkingCar> parkingCar = new ArrayList<ParkingCar>();
        //初始化输入流
     ...
     * @return
     */
    private List<ParkingCar> readExcelValue(Workbook wb) throws ParseException {
        //得到第一个shell
