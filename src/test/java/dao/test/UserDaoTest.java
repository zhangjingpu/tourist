...
public class UserDaoTest {
    ...
    */
    ...
    public void loginTest1() {
        ...
        //断言此姓名和密码的用户为空
        Assert.assertEquals(sysuserDao.login(user), null);
        */

        SysUser user2 = new SysUser();
        user2.setAccount("123");
        user2.setPassword(MD5Util.MD5Encode("123", "UTF-8"));
        System.out.println(sysuserDao.login(user2).toString());
        //断言此姓名和密码的用户可以登录成功,且用户id为1
        // Assert.assertTrue(sysuserDao.login(user2).getAccount() == "123");
